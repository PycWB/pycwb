...
dbeta3 = Parameter("dbeta3",
                ...
                description="Intermediate testingGR parameter.")
#
#  Parameters for Hyperbolic waveform
#
hyp_eccentricity = Parameter("hyp_eccentricity",
                dtype=float, default=0., label=r"$e$",
                description="Hyperbolic Eccentricity.")
b = Parameter("b",
                dtype=float, default=0., label=r"$b$",
                description="Impact Parameter.")
ui = Parameter("ui",
                dtype=float, default=0., label=r"$u_i$",
                description="Initial Eccentric Anomaly.")
uf = Parameter("uf",
                dtype=float, default=0., label=r"$u_f$",
                description="Final Eccentric Anomaly.")
li = Parameter("li",
                dtype=float, default=0., label=r"$l_i$",
                description="Initial Mean Anomaly.")
lf = Parameter("lf",
                dtype=float, default=0., label=r"$l_f$",
                description="Final Mean Anomaly.")
...
Hyperbolic_params = ParameterList\
    ([hyp_eccentricity, b, ui, uf, li, lf])
...
cbc_intrinsic_params = ParameterList\
    ...
    testingGR_params + Hyperbolic_params
