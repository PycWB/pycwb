...
class TestAngularDistance:
    ...
    def test_known_distance(self):
        """Paris (48.9°N, 2.3°E) to New York (40.7°N, 74.0°W) ≈ 5837 km ≈ 52.5°."""
        d = _angular_distance_deg(2.3, 48.9, -74.0, 40.7)
        # ~52.5 degrees angular separation
        assert 52.0 < d < 53.0
...
class TestCwbToGeo:
    ...
    def test_phi_below_180(self):
        ...
        assert theta_geo == pytest.approx(60.0)  # 90 - 30

    def test_phi_above_180(self):
        """Phi > 180 wraps to negative (phi - 360)."""
        phi_geo, theta_geo = _cwb_to_geo(200.0, 10.0)
        assert phi_geo == pytest.approx(-160.0)  # 200 - 360
        assert theta_geo == pytest.approx(80.0)   # 90 - 10
    ...
    def test_phi_zero(self):
        ...
        assert theta_geo == pytest.approx(45.0)  # 90 - 45
    ...
    def test_negative_theta(self):
        ...
        assert theta_geo == pytest.approx(110.0)  # 90 - (-20) = 110
