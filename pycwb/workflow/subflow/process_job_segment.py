...
from pycwb.modules.read_data import generate_injections, generate_noise_for_job_seg, read_from_job_segment
    ...
    for trail_idx in trail_idxs:
        ...
        for lag, fragment_cluster in enumerate(super_fragment_clusters):
            ...
            for trigger_folder, trigger in zip(trigger_folders, events_data):
                ...
                reconstruct_waveforms_flow(trigger_folder, config, sub_job_seg.ifos,
                                        event, cluster,
