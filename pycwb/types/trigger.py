...
# ---------------------------------------------------------------------------
# InjectionParams  (simulation-only sub-structure — see pycwb.types.simulation)
# ---------------------------------------------------------------------------

from pycwb.types.simulation import InjectionParams  # noqa: E402

# InjectionParams is re-exported here so that existing callers using
# ``from pycwb.types.trigger import InjectionParams`` continue to work.
